...
export default function HomePage() {
  const { beVip, parkUp, beVipArena } = useImages();
        ...
        <div className="geomatric-background bg-no-repeat object-contain bg-right-bottom">
          <div className="container bg-main object-cover bg-center">
            <div className="h-[95vh]">
              <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 items-center gap-10">
                <div className="flex flex-col col-span-2 justify-center gap-5 h-[95vh]">
                  <motion.h1
                  ...
                  <motion.p
                    className="text-lightgray text-sm mt-5 leading-6 lg:min-w-[600px] lg:max-w-[650px]"
                    initial={{ clipPath: "inset(100% 0 0 0)" }}
                    animate={{ clipPath: "inset(0% 0 0 0)" }}
                    transition={{ duration: 0.3, delay: 0.7 }}
                  >
                    Word spread quickly, not through grandiose advertising but
                    through the sincere, glowing recommendations of those the
                    magic had touched.
                  ...
                  <motion.div
                    ...
                    className="  md:flex-row flex-col md:items-center gap-5 mt-16 md:block hidden "
                  >
                    <h2 className="text-lightgray text-2xl font-bold">
                      Inspiration for the <br /> grandest brands on earth.
                    </h2>

                    <div className="flex flex-row md:flex-nowrap mt-4 flex-wrap items-center gap-6 ">
                      <Image
                        src={beVip}
                        alt="beVip"
